# -*- coding: utf-8 -*-
"""
Created on Fri Sep 25 01:58:45 2020
...
train_path='C:/Users/Panagiotis Gkanos/Desktop/multiclass dataset/200X/train'
...
valid_path='C:/Users/Panagiotis Gkanos/Desktop/multiclass dataset/200X/valid'
...
test_path='C:/Users/Panagiotis Gkanos/Desktop/multiclass dataset/200X/test'
...
history=model.fit_generator(train_batches, steps_per_epoch=20, 
                    validation_data=valid_batches, validation_steps=15, epochs=120)
loss, acc = model.evaluate_generator(test_batches,val_samples=200)
print(loss, acc)
