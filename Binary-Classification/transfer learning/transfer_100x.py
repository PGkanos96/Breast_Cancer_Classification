# -*- coding: utf-8 -*-
"""
Created on Fri Sep 25 00:04:24 2020
...
history=model.fit_generator(train_batches, steps_per_epoch=20, 
                    validation_data=valid_batches, validation_steps=15, epochs=80)
loss, acc = model.evaluate_generator(test_batches,val_samples=400)
print(loss, acc)
