...
train_path='C:/Users/Panagiotis Gkanos/Desktop/dataset/100X/train'
...
valid_path='C:/Users/Panagiotis Gkanos/Desktop/dataset/100X/valid'
valid_batches=datagen.flow_from_directory(valid_path,
                                            target_size=[400,400],
                                            classes=['malignant','benign'],
                                            class_mode='categorical', batch_size=20,seed=7)

test_path='C:/Users/Panagiotis Gkanos/Desktop/dataset/100X/test'
...
model.add(Conv2D(64,(5,5),strides=1,padding='same',kernel_initializer=init))
model.add(Activation('relu'))
model.add(BatchNormalization())
...
filepath='C:/Users/Panagiotis Gkanos/Desktop/X100/3x16-3x32-1x64-1x128-256-128-2.5x5/BN+DO+z-score+he+HF+VF+RR30+BR.best.hdf5'
